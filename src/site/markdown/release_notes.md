...
* CDK-286: Upgrade kite-morphlines-saxon module from Saxon-HE-9.5.1-3 to Saxon-HE-9.5.1-5
...
This patch release is fully-compatible with Kite 0.10.1, which uses the new Kite packages.
